...
insert into empresa (id, cnpj, nome_fantasia, razao_social, tipo, data_fundacao, ramo_atividade_id) values (5, '45.185.196/0001-74', 'Casa de Carnes Ribeiro', 'Silvio Santos Ltda', 'LTDA', '2009-06-02', 1);
insert into empresa (id, cnpj, nome_fantasia, razao_social, tipo, data_fundacao, ramo_atividade_id) values (6, '48.415.141/0001-00', 'Guarapari Supermercados', 'Guarapari S.A.', 'SA', '1997-01-10', 2);
insert into empresa (id, cnpj, nome_fantasia, razao_social, tipo, data_fundacao, ramo_atividade_id) values (7, '88.356.448/0001-93', 'Veneza Supermercados', 'Rita Cadillac', 'MEI', '2014-12-15', 3);
insert into empresa (id, cnpj, nome_fantasia, razao_social, tipo, data_fundacao, ramo_atividade_id) values (8, '73.027.487/0001-70', 'Barber"s Barbearia', 'Cigano EIRELI ME', 'EIRELI', '2009-09-02', 4);